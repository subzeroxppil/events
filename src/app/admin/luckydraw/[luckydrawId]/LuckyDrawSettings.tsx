...
const LuckyDrawSettings: React.FC<LuckyDrawSettingsProps> = React.memo(({
  ...
  const updateSetting = React.useCallback(<K extends keyof AnimationSettings>(
    key: K,
      ...
      <SheetContent className="overflow-y-auto w-[400px] sm:w-[540px]">
        ...
        <div className="mt-6 space-y-6 pb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium">Deceleration Intensity</label>
                <span className="text-sm text-muted-foreground">{settings.easeExponent}</span>
              </div>
              <input
                type="range"
                min="2"
                ...
                onChange={(e) => updateSetting('easeExponent', parseInt(e.target.value))}
                className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                disabled={isSpinning}
              />
              <div className="text-xs text-muted-foreground">
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <span
                  className={cn(
                    "inline-block h-4 w-4 transform rounded-full bg-white transition-transform",
                    settings.enableFireworks ? "translate-x-6" : "translate-x-1"
                  )}
                />
              </button>
            </div>
            ...
            {showAdvancedSettings && (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-muted-foreground">{settings.minSpins}</span>
                      </div>
                      <input
                        type="range"
                        min="1"
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-muted-foreground">{settings.maxSpins}</span>
                      </div>
                      <input
                        type="range"
                        min="2"
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <label className="text-sm font-medium">Idle Animation Speed</label>
                      <span className="text-sm text-muted-foreground">{settings.idleSpeed}px/s</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                      ...
                      onChange={(e) => updateSetting('idleSpeed', parseInt(e.target.value))}
                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                      disabled={isSpinning}
                    />
                    <div className="text-xs text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) => updateSetting('visibleRange', parseInt(e.target.value))}
                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                      disabled={isSpinning}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => updateSetting('centerItemScale', parseInt(e.target.value) / 100)}
                        className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                        disabled={isSpinning}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => updateSetting('nearCenterScale', parseInt(e.target.value) / 100)}
                        className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                        disabled={isSpinning}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <label className="text-sm font-medium">Edge Blur Intensity</label>
                      <span className="text-sm text-muted-foreground">{settings.maxBlur}px</span>
                    </div>
                    <input
                      type="range"
                      min="0"
                      ...
                      onChange={(e) => updateSetting('maxBlur', parseFloat(e.target.value))}
                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                      disabled={isSpinning}
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={cn(
                          "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                          settings.useCustomColors ? "bg-blue-600" : "bg-gray-200"
                        )}
                        disabled={isSpinning}
                      >
                        <span
                          className={cn(
                            "inline-block h-4 w-4 transform rounded-full bg-white transition-transform",
                            settings.useCustomColors ? "translate-x-6" : "translate-x-1"
                          )}
                        />
                      </button>
                    </div>
                ...
                {settings.enableSounds && (
                  <div className="space-y-4">
                    <h4 className="text-md font-semibold text-gray-700">Audio Settings</h4>
                    <div className="space-y-3 p-3 bg-gray-50 rounded-lg">
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-xs font-medium">Sound Fade Start</label>
                          <span className="text-xs text-muted-foreground">
                            {(settings.soundFadeStartPercent * 100).toFixed(0)}%
                          </span>
                        </div>
                        <input
                          type="range"
                          ...
                          onChange={(e) => updateSetting('soundFadeStartPercent', parseFloat(e.target.value))}
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-xs font-medium">Fade Duration</label>
                          <span className="text-xs text-muted-foreground">
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('soundFadeDuration', parseFloat(e.target.value))}
                          className="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                          disabled={isSpinning}
                        />
                      </div>
                ...
                {settings.enableFireworks && (
                  <div className="space-y-4">
                    <h4 className="text-md font-semibold text-gray-700">Celebration Effects</h4>
                    <div className="grid grid-cols-2 gap-3 p-3 bg-gray-50 rounded-lg">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('fireworksDuration', parseInt(e.target.value))}
                          className="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                          disabled={isSpinning}
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => updateSetting('fireworksParticleCount', parseInt(e.target.value))}
                          className="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                          disabled={isSpinning}
                        />
                      </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-medium">Winner Display Time</label>
                    <span className="text-sm text-muted-foreground">
                  ...
                  <input
                    ...
                    onChange={(e) => updateSetting('winnerDisplayDuration', parseInt(e.target.value))}
                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                    disabled={isSpinning}
                  />
                </div>
                ...
                {/* Performance */}
                <div className="space-y-4">
                  <h4 className="text-md font-semibold text-gray-700">Performance</h4>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <label className="text-sm font-medium">Spinner Item Pool</label>
                      <span className="text-sm text-muted-foreground">
                    ...
                    <input
                      ...
                      onChange={(e) => updateSetting('spinnerItemCount', parseInt(e.target.value))}
                      className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                      disabled={isSpinning}
                    />
                    <div className="text-xs text-muted-foreground">
