    ...
    const exportData = usersData.map((user, index) => {
      ...
      if (includeGroupNumber) {
        if (isSDC18Event) {
          ...
          const chronologicalIndex = sortedByRegistration.findIndex(
            (u) => u.workId === user.workId
          );
          row[headers.group] = chronologicalIndex < 120 ? "A" : "B";
        } else {
          row[headers.groupNumber] = user.groupNumber;
        }
      }
                                          ...
                                          <TableCell>
                                            {(() => {
                                              const chronologicalIndex =
                                                sortedByRegistration.findIndex(
                                                  (u) =>
                                                    u.workId === user.workId
                                                );
                                              return chronologicalIndex < 120
                                                ? "A"
                                                : "B";
                                            })()}
                                          </TableCell>
